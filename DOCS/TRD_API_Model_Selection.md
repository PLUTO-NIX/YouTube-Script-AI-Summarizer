...
<div class="section">
    ...
    <div class="radio-group">
        ...
        <div class="radio-item">
            <input type="radio" id="gemini-1.5-pro" name="aiModel" value="gemini-1.5-pro">
            <div>
                <label for="gemini-1.5-pro" class="radio-label">
                    Google Gemini 1.5 Pro
                    <span class="model-badge">고성능</span>
                </label>
                <p class="radio-description">
                    고성능 모델 (Gemini API 키 필요)
                </p>
            </div>
        </div>
    </div>
